function [channelGain,APpositions,UEposition] = RandomAP_generateSetup_Rician_Multi_Antenna(M,K,nbrOfSetups,correlatedShadowing)
%%=============================================================
...
%
%OUTPUT:
%R_AP                 = Matrix with dimension L x L x M x K x nbrOfSetups
%                       where (:,:,m,k,n) is the spatial correlation matrix
%                       between AP m and UE k in setup n, normalized by noise
%                       power
%R_UE                 = Matrix with dimension N x N x M x K x nbrOfSetups
%                       where (:,:,m,k,n) is the spatial correlation matrix
%                       between AP m and UE k in setup n

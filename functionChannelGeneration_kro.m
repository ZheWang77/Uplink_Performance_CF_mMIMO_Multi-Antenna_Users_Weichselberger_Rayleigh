function [HH,R_Vec,H_Vec,Omega] = functionChannelGeneration_kro(channelGain,M,K,N,L,nbrOfRealizations)
%%=============================================================
%The file is used to generate the Kronecker model based channel of the paper:
%
...
for k = 1:K
    for m = 1:M
        ...
        Lambda_t = sum(Omega1,1)';
        Lambda_r = sum(Omega1,2);
        
        Omega0 = Lambda_r*Lambda_t'/(L*N);
